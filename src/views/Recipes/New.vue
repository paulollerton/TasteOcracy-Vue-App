  ...
  <div class="recipes-new">
    ...
    <form v-on:submit.prevent="submit()">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="created-by" placeholder="Lord Voldemort" v-model="newRecipeCreatedBy">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="ingredients" placeholder="Lord Voldemort" v-model="newRecipeIngredients">
          </div>
          <div class="form-group">
            <label for="directions">Directions</label>
            <input type="text" class="form-control" id="directions" placeholder="Lord Voldemort" v-model="newRecipeDirections">
          </div>
  ...
  methods: {
    submit: function() {
      ...
      var params = {
        ...
        created_by: this.newRecipeCreatedBy,
